...
public class Common {
    ...
    //把请求参数转成一个json对象
    public static JSONObject getRequestJsonObject(InputStream inputStream, String uncode) throws Exception {
		InputStreamReader input = new InputStreamReader(inputStream, uncode);
		BufferedReader bufReader = new BufferedReader(input);
		String line = "";
		StringBuilder contentBuf = new StringBuilder();
		...
		String data=contentBuf.toString();
		System.out.println("Request输入的参数：【"+data+'】');
		if (data.equals("")){
			data="{}";
		}
