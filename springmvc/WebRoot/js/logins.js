...
$(function(){
	...
	function addGridRow(){
		var txt = "<tr><td></td><td></td><td></td><!--td></td--><td></td><td class='customerCol'></td><td></td></tr>";
		...
		$(cells[ci_status]).addClass("tb_fix_width_short0");
		...
		$(cells[ci_customer]).html("<div class=\"input_select_wraper remove_left_margin\"><div class=\"input_select_down_btn\"><div class=\"input_select_down_arrow\"></div></div><div class=\"input_select_text_wraper\"><input type=\"text\" id=\"customers\" class=\"input_select_text_field\"/></div><div class=\"input_select_list_wraper\"></div></div>");
