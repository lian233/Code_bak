...
import com.wofu.intf.chinapay.util.Base64Code;
...
{
	public static BASE64Encoder  base64encoder=null;
	public DtcUtil()
	{
	...
	public static Map<String,String>  makeRequestParams(String bizdata)
		throws Exception
	{

		HashMap<String,String> params = new HashMap<String,String>();
		params.put("data", base64encoder.encode(bizdata.getBytes("utf-8")));
		//params.put("data", Base64Code.encodeString(bizdata));
		return params;
	}
	...
	*/
	...
	//处理方法
	public static String process(String bizData) throws Exception{
		Map requestParams=DtcUtil.makeRequestParams(DtcUtil.filterChar(bizData.toString()));
		return CommHelper.sendRequest(Params.url, requestParams, "");
	}
