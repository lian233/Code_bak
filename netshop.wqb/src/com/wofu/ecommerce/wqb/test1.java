...
public class test1 {
	...
	public static String url = "http://121.41.165.60/Maisk/wqbnew/api.res";
	...
	public static String app_key = "wolf_123_wolf";

	public static String checkcode  = "73-66-5256122-71-61-513427-17-80-35-63-128115";
	
	public static String secretkey="wolf_123_wolf";
	...
	public static String method="json";
	/**
	 * @param args
	 */
	...
	*/
	...
	public static void getStock() throws Exception
	{
		...
		String sku ="22010303029001070";
		Map<String, String> paramMap = new HashMap<String, String>();
        //系统级参数设置
        paramMap.put("user", app_key);
        paramMap.put("appKey", app_key);
        paramMap.put("format", "json");
        paramMap.put("method", method);
        
        paramMap.put("proSkuNo",sku);
        
		String responseData =Utils.sendByPost(paramMap, secretkey,method, url);
