...
public class Order extends BusinessObject{
	...
	private float collectOnDeliveryAmount; //货到付款金额
	...
	public float getCollectOnDeliveryAmount() {
		return collectOnDeliveryAmount;
	}
	public void setCollectOnDeliveryAmount(float collectOnDeliveryAmount) {
