...
public class GenCustomerOrder extends Thread{
	private static String jobName = "阿里巴巴订单生成客户订单作业";
	...
	public void run() {
		...
		do {
			...
			try 
			{
				connection = PoolHelper.getInstance().getConnection(com.wofu.ecommerce.alibaba.Params.dbname);	
				//生成阿里巴巴新订单
			...
			while (System.currentTimeMillis() - startwaittime < (long) (com.wofu.ecommerce.alibaba.Params.waittime * 1000))
				try {
					sleep(1000L);
				} catch (Exception e) {
