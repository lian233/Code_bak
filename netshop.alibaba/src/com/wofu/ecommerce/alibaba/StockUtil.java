...
public class StockUtil
{
	...
	public static void updateStock(DataCentre dao,String SERVER_URL,String token,
			String appKey,String appSecret,ECS_StockConfigSku stockconfigsku,int qty) throws Exception
	{
		try
		{
			//获取商品的详情
			...
			String response =ApiCallService.callApiTest(Params.url, urlPath, appSecret, params);
			...
			String urlPath1=CommonUtil.buildInvokeUrlPath(Params.namespace,modify_apiName,Params.version,Params.requestmodel,Params.appkey);
			//执行修改
			String response1 =ApiCallService.callApiTest(Params.url, urlPath1, appSecret, params1);
