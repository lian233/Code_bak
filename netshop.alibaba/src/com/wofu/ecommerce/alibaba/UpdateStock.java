...
public class UpdateStock extends Thread{
	...
	private static String jobname = "更新阿里巴巴库存作业";
		...
		for(int i=0;i<vtinfo.size();i++)
		{
			...
			{		
				...
				for (int j=0;j<vtstockconfigsku.size();j++)
				{
					...
					StockUtil.updateStock(dao,Params.url,Params.refresh_token,Params.appkey,Params.secretKey,stockconfigsku,newqty);
