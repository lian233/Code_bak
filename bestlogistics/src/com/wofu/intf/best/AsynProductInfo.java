			...
			try {					
				...
				for(Iterator it=infsheetlist.iterator();it.hasNext();)
				{
					...
					.append("a.action,b.goodsname,b.customno,b.deptname,b.barcodeid,b.goodsid,")
						.append("b.colorname,b.sizename,b.pkspec,b.baseprice,isnull(b.SeriesID,'') as SeriesID,isnull(b.weigh,0) weight from BarcodeTranList a with(nolock),v_barcodeall b with(nolock)")
					...
					if(bizData.indexOf("<product>")!=-1){
						...
						bizData.append("</"+serviceType+">");
						String bizData1 = BestUtil.filterChar(bizData.toString() );
						Log.info("尾数bizData: "+bizData.toString());
					...
					if(isSuccess){
						...
						BestUtil.recordMsg(conn,msgid,sheetid,2201,serviceType);
						conn.commit();
