...
public class test1 {
	...
	public static String url = "http://openapi.1mall.com/forward/api/rest/router";
	...
	public static void getOrderDetail() throws Exception
	{
        ...
        String responseData =Utils.sendByPost(paramMap, "", Params.url);
	...
	public static void getLogisticsCompany() throws Exception
	{
        ...
        String responseOrderListData = Utils.sendByPost(paramMap, "", Params.url);
	...
	*/
	...
	public static void searchDeliveryInfo() throws Exception{
		Map<String, String> orderlistparams = new HashMap<String, String>();
        //系统级参数设置
		orderlistparams.put("app_id", "ea3d8e2b13e7fbf1e5");
        orderlistparams.put("format", "json");
        orderlistparams.put("method", "kdt.logistics.trace.search");
        orderlistparams.put("sign_method", "MD5");
        orderlistparams.put("v", "1.0");
        orderlistparams.put("timestamp", Formatter.format(new Date(), Formatter.DATE_TIME_FORMAT));
        orderlistparams.put("tid", "E20150302092815721914");
        
        String responseOrderListData = Utils.sendByPost(orderlistparams, "4bf4076a46c9f662146ee16e80ee310e", "http://open.koudaitong.com/api/entry");
