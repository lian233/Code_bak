...
public class CheckOrderStatus {
	...
	public static void main(String[] as){
		...
		List signParams;
		try {
			signParams = crossborderUtil.makeSignParams(bizData.toString(), serviceType,msgtype,
				partnerid,partnerkey,serviceversion,callbackurl,msgId);
			String sign=crossborderUtil.makeSign(signParams);


			Map requestParams=crossborderUtil.makeRequestParams(bizData.toString(), serviceType, 
