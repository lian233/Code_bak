...
public class Params {
	// 请求URL地址
	public static String dbname = "ylw";
	public static String pageSize = "10";
	public static final String url = "http://service.dev.ulechina.tom.com/api/";
	...
	public static void init(Properties properties)
	{
		...
		version_no= properties.getProperty("version_no","10");
		//获取对应的快递公司名称
