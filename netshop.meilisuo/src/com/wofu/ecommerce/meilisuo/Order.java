...
public class Order extends BusinessObject{
	...
	private DataRelation orderItemList =new DataRelation("orderItemList","com.wofu.ecommerce.meilisuo.OrderItem");
	private DataRelation serviceList =new DataRelation("serviceList","com.wofu.ecommerce.meilisuo.Service");
