...
public class GenCustomerOrder extends Thread{
	private static String jobName = "苏宁订单生成客户订单作业";
	...
	public void run() {
		...
		do {
			...
			try 
			{
				...
				SuNing.setCurrentDate_genOrder(new Date());
				//生成苏宁新订单
