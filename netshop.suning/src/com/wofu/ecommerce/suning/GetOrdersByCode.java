...
public class GetOrdersByCode extends Thread {
				...
				while(hasNextPage)
				{
					...
					{	//某个订单
						...
						{	
							...
							//商品sku
							String itemCode= OrderUtils.getItemCodeByProduceCode(item.getProductCode(),Params.appKey,Params.appsecret,Params.format)[0];
							item.setItemCode(itemCode);
							//商品图片链接
							String itemImg= OrderUtils.getItemCodeByProduceCode(item.getProductCode(),Params.appKey,Params.appsecret,Params.format)[1];
