...
public class test11
{
		...
		throws Exception
	{
		...
		stringbuffer.append((new StringBuilder()).append("</").append(s).append(">").toString());
		String s1 = "10001";
		java.util.List list = TianTuUtil.makeSignParams(stringbuffer.toString(), s, msgtype, partnerid, partnerkey, serviceversion, callbackurl, s1);
		String s2 = TianTuUtil.makeSign(list);
		java.util.Map map = TianTuUtil.makeRequestParams(stringbuffer.toString(), s, s1, msgtype, s2, callbackurl, serviceversion, partnerid);
		...
		throws Exception
	{
		...
		stringbuffer.append((new StringBuilder()).append("</").append(s).append(">").toString());
		String s2 = "100027";
		java.util.List list = TianTuUtil.makeSignParams(stringbuffer.toString(), s, msgtype, partnerid, partnerkey, serviceversion, callbackurl, s2);
		String s3 = TianTuUtil.makeSign(list);
		java.util.Map map = TianTuUtil.makeRequestParams(stringbuffer.toString(), s, s2, msgtype, s3, callbackurl, serviceversion, partnerid);
