	...
	public void process() throws Exception {
		...
		try
		{
			...
			if (checkType.equalsIgnoreCase("WMS_ADJUSTFEEDBACK"))
			{
				...
				IntfUtils.upNote(this.getExtconnection(), owner, commsheetid, 2449, this.getInterfaceSystem(), TianTuUtil.getShopID(this.getExtconnection(),customerCode,warehouseCode));
