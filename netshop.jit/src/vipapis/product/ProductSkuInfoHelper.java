...
public  class ProductSkuInfoHelper implements com.vip.osp.sdk.base.BeanSerializer<ProductSkuInfo>
{
	
	public static final ProductSkuInfoHelper OBJ = new ProductSkuInfoHelper();
	...
	public void read(ProductSkuInfo struct, Protocol iprot) throws OspException {
	...
	public void write(ProductSkuInfo struct, Protocol oprot) throws OspException {
	...
	public void validate(ProductSkuInfo bean) throws OspException {
