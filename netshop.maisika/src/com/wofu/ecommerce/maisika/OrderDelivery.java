...
{
	private static String jobname = "麦斯卡订单发货处理作业";
	...
	{	
		...
		{	
			...
			map.put("&op","deliver");
	        map.put("service","deliver");
	        map.put("vcode", Params.vcode);
	        map.put("order_sn",orderid);
	        map.put("express_company",URLEncoder.encode(post_company, "UTF-8"));
	        map.put("express_id",post_no);
...
//			/**错误处理**/
			if (responseproduct.getString("msg").equals("订单状态已经改变，无法重新发送！"))
			{	
				String errdesc = "";
				errdesc = errdesc + " "
