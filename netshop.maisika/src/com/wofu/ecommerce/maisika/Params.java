...
public class Params {
	...
	public static final String url = "http://www.mesuca.com/shop/index.php?act=api";
	public static String tradecontactid = "16";
	public static String encoding = "GBK";
	public static int total = 10;
	public static int waittime = 10;
	public static String orderState = "101";
	public static String username = "麦斯卡";
	...
	public static String vcode="h9iX0TiKwmxtX0xrfVwKrJ";
	public static String pageSize = "10";
	
	public static void init(Properties properties)
	{
		dbname = properties.getProperty("dbname", "dangdang");
		tradecontactid=properties.getProperty("tradecontactid","15");
		...
		username=properties.getProperty("username","麦斯卡");
