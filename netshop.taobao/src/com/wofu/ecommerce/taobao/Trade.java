...
public class Trade extends BusinessObject {
	...
	private DataRelation orders =new DataRelation("order","com.wofu.ecommerce.taobao.Order");
	
	private DataRelation promotion_details =new DataRelation("promotion_detail","com.wofu.ecommerce.taobao.PromotionDetail");
	private DataRelation service_orders = new DataRelation("service_order","com.wofu.ecommerce.taobao.ServiceOrder");
