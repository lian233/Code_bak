...
public class test1 {
	...
	public static String url = "http://mesuca.shoperke.com/api/syn";
	...
	*/
	...
	public static Element getItemById() throws Exception{
		String method ="search_goods_detail";
		Map<String, String> orderlistparams = new HashMap<String, String>();
        //系统级参数设置
		orderlistparams.put("api_version", "1.0");
        orderlistparams.put("act", method);
        orderlistparams.put("goods_id", "4545");
		String responseOrderListData = Utils.sendByPost(orderlistparams, url);
