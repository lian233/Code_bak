...
public class StockUtils {
	public static boolean updateStock(String url,String ver,ECS_StockConfigSku ecs_stockconfigsku,int qty) throws Exception
	{
		boolean flag=false;
        ...
        updatestockparams.put("store", String.valueOf(qty));
		...
		if (!"success".equals(res))
		{
			...
			Log.warn("库存更新失败,SKU:["+ecs_stockconfigsku.getSku()+"],更新数量:["+qty+"] 错误信息:"+errorMsg);
		}
		else
		{
			flag=true;
			Log.info("库存更新成功,SKU:["+ecs_stockconfigsku.getSku()+"],更新数量:["+qty+"]");
		}
