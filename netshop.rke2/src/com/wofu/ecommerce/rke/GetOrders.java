		...
		for(int k=0;k<10;)
		{
			try
			{
				while(true)
				{
					...
					optBuffer.append("act=api&op=orders&service=order&vcode=h9iX0TiKwmxtX0xrfVwKrJ&page="+pageno+"&page_size="+Params.pageSize+"&status=1");
					...
					int totalCount = Integer.parseInt(resultObject.optString("totalcount","0"));
					if (totalCount==0)
					{				
						if (pageno==1L)		
						{
