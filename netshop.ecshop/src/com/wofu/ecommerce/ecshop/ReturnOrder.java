...
public class ReturnOrder extends BusinessObject{
	...
	private int order_status;//订单状态 order_status  0 未确认 1 确认 2 已取消 3 无效 4 退货 
	private int shipping_status;// 0 未发货 1 已发货 2 已收货 4 退货
	private int pay_status;//是否支付  pay_status 0 未付款 1 付款中 2 已付款
