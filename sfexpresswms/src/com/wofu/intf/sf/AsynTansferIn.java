		...
		do {		
			...
			try {					
				...
				for(Iterator it=infsheetlist.iterator();it.hasNext();)
				{
					...
					//取订单信息
					String sql="select sheetid,outshopid,inshopid,note,checkdate,flag from transfer0 where sheetid='"+sheetid+"'";
					...
					sql="select isnull(linkman,'"+Params.linkman+"') linkman,zipno,linktele,mobileno,email,address from shop where id='"+outshopid+"'";
				...
				/*	sql="select b.custombc,b.goodsname,a.outqty,b.colorname,b.sizename "
					...
					sql = new StringBuilder().append("select b.").append(Params.isBarcodeId?"barcodeid,":"custombc,")
						...
						.append(" from transferitem0 a,v_barcodeall b")
