			...
			if (checkType.equalsIgnoreCase("WMS_ADJUSTFEEDBACK"))
			{
				...
				for(int i=0;i<productNodeList.getLength();i++)
				{
					...
					sql = new StringBuilder().append("select goodsid,barcodeid from barcode where ")
						.append("custombc='").append(skuCode)
						.append("'").toString();
				...
				IntfUtils.upNote(this.getExtconnection(), owner, commsheetid, 2449, this.getInterfaceSystem(), sfUtil.getShopID(this.getExtconnection(),customerCode,warehouseCode));
