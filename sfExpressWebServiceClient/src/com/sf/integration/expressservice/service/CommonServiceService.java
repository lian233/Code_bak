 ...
 * 
 */
@WebServiceClient(name = "CommonServiceService", targetNamespace = "http://service.expressservice.integration.sf.com/", wsdlLocation = "http://bsp-oisp.sf-express.com/bsp-oisp/ws/expressService?wsdl")
	...
	static {
		...
		try {
			...
			baseUrl = com.sf.integration.expressservice.service.CommonServiceService.class
					.getResource(".");
			url = new URL(baseUrl,
					"http://bsp-oisp.sf-express.com/bsp-oisp/ws/expressService?wsdl");
		} catch (MalformedURLException e) {
			logger
					.warning("Failed to create URL for the wsdl Location: 'http://bsp-oisp.sf-express.com/bsp-oisp/ws/expressService?wsdl', retrying as a local file");
